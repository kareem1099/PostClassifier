...
df = pd.read_excel(r"C:\Users\Kareem\Desktop\FINALELFINAL.xlsx", sheet_name="New folder (3)", names=["Source", "Post", "Tag"], skiprows=1)
...
training_args = TrainingArguments(
    output_dir=r"D:\xlmr_final_model\xlmr_logs",
    eval_strategy="epoch",
    save_strategy="epoch",
    learning_rate=5e-5,             
    ...
    logging_dir=r"D:\xlmr_final_model\xlmr_logs\logs",
